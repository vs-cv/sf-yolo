...
parser.add_argument('--scenario_name', type=str, required=True, choices=['voc2clipart', 'voc2wc', 'city2foggy' ,'KC','city', 'bdd100k'],
...
assert args.scenario_name in ['voc2clipart', 'voc2wc', 'city2foggy' ,'KC', 'city', 'bdd100k'], \
